...
void AshCrow(){	//  	1/1		1/2	  1/2dot  1/2trip  1/4   1/4dot  1/4tri  1/8   1/8dot 1/8tr  1/16    1/16tri
	float time[12] = {3428.57,1714.29,62571.43,1142.86,857.14,1285.71,571.43,428.57,642.86,285.71,214.29,142.86}; //music measurements with tempo 70bpm
			//1st Part (1)
	for(int i=0;i<2;i++){
...
//you can insert any functions here with the same format of Beep Music and then play it by adding it to the list in DBmain.cpp
